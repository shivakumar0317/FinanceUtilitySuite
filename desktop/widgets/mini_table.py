...
class MiniTable(ctk.CTkFrame):
    ...
    def __init__(self, master, title: str = ""):
        ...
        style.configure("Mini.Treeview", rowheight=28, font=("Segoe UI", 10))

        style.configure("Mini.Treeview.Heading", font=("Segoe UI", 10, "bold"))
        ...
        self.tree = ttk.Treeview(
            self, columns=columns, show="headings", height=8, style="Mini.Treeview"
        )
    ...
    def load_data(self, rows):
        ...
        for symbol, price, change in rows:
            ...
            self.tree.insert(
                "", "end", values=(symbol, f"₹{price:,.2f}", f"{change:.2f}%")
            )
